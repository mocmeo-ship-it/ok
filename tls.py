...
def ipfd():
	forwarded_for_ips = ['0.0.0.0', '192.168.0.1', '10.0.0.1', '172.16.0.1', '203.0.113.1', '198.51.100.1', '192.0.2.1', '128.0.0.1', '172.31.0.1', '240.0.0.1', '127.0.0.1', '169.254.1.1', '100.64.0.1', '::1', '2001:db8::1', 'fe80::1', 'fd12:3456:789a:1::1', '2001:0db8:85a3:0000:0000:8a2e:0370:7334', '2001:db8:1234:5678:90ab:cdef:8765:4321', 'fe80:0:0:0:202:b3ff:fe1e:8329', 'fd12:3456:789a:1:cabc:dxyz:efab:1234', '103.52.120.0', '45.56.120.20', '79.34.56.178', '112.204.23.186', '217.195.102.124', '51.68.214.206', '98.143.144.86', '182.168.20.193', '62.171.177.101', '123.45.67.89', '203.0.113.55', '1.1.1.1', '1.0.0.1', '2001:0db8:1234:5678:90ab:cdef:8765:4321', '127.0.0.1',]
...
def headers_shit():
	...
	ctrolshit=ctrol()
	pregnantj=pregnant()
	dnt_shit= random.choice(['0', '1'])
	trailer_shit= random.choice(['trailers', 'gzip', 'deflate'])
	fuckyou=random.choice(['document', 'image', 'script', 'style', 'font'])
	shitheader=random.choice(['navigate', 'cors', 'no-cors', 'same-origin'])
	damnmtf= random.choice(['same-origin', 'cross-site'])
	shitfetch=random.choice(['?1', '?0'])
	headers = {
	'User-Agent': randuas,
